                ...
                Case " "
                    If semicolon = True Then
                        Select Case tempWord.Replace(Chr(13), "").Replace(Chr(10), "").ToLower
                            Case "message", "echo", "sleep", "wait", "deldir", "copydir", "delfile", "copyfile", "movedir", "movefile", "start", "startwait", "goto", "ifdirexist", "iffileexist", "shell", "writefile", "writefileappend", "mkdir", "taskkill", "taskclose", "iftaskexist", "gosub", "wget", "readfile", "ifstringequal", "ifstringcontain", "calculate", "set", "substring", "replacestring", "setregvalue", "getregvalue", "createregkey", "delregkey", "delregvalue", "ifpingsuccessfull", "if", "changedir", "cd", "clearline"
                                RichTextBox2.Select(startIndex, tempWord.Length)
                                RichTextBox2.SelectionColor = Color.DarkGreen
                                'RichTextBox1.SelectionFont = New Font(DefaultFont.FontFamily, 12, FontStyle.Bold)
                            Case "title", "visible", "log", "include", "size", "opacity", "topmost", "fontsize"
                                RichTextBox2.Select(startIndex, tempWord.Length)
